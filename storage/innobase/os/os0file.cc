...
UNIV_INTERN mysql_pfs_key_t  innodb_file_parallel_dblwrite_key;
#endif /* UNIV_PFS_IO */
...
# ifdef UNIV_LINUX
                /* Parallel double-write buffer patch:
                lower the severity of this message from
                warning to info since the pdwb file is
                always opened with O_DIRECT. This is to
                breaking mysql-test miserably when running
                on tmpfs. */
				ib_logf(IB_LOG_LEVEL_INFO,

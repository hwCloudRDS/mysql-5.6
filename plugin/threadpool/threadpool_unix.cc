...
//copy from percona 5.6 includ/my_sys.h
...
{
  const ulong mode= TP_HIGH_PRIO_MODE_TRANSACTIONS; //TODO: get rid of threadpool_high_prio_mode
  ...
  return (mode == TP_HIGH_PRIO_MODE_STATEMENTS) ||
    (mode == TP_HIGH_PRIO_MODE_TRANSACTIONS && c->tickets > 0 &&
     (thd_is_transaction_active(c->thd) ||
      ...
      //TODO: ||
      //TODO: add this feature later c->thd->backup_tables_lock.is_acquired() ||
      //TODO: add this feature later c->thd->backup_binlog_lock.is_acquired() ||
      //TODO: add this feature later c->thd->ull_hash.records > 0)
}
...
bool tp_init()
{
  ...
  //it should be called by default scheduler initialization scheduler_init();

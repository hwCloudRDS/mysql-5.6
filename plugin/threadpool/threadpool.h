...
extern uint threadpool_prio_kickup_timer; /* boost connection from low priority queue to high priority, in ms */
...
extern uint threadpool_high_prio_tickets; /* Num of tickets to enter high prio queue */
